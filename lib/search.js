...
var search = exports.search = function search(podcast) {
  ...
  return fetch(_config2.default + '/search.json?q=' + str).then(_utils.toJSON);
};

var top = exports.top = function top() {
  var value = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 10;
  return fetch(_config2.default + '/toplist/' + value + '.json').then(_utils.toJSON);
};

var listTags = exports.listTags = function listTags() {
  var value = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 10;
  return fetch(_config2.default + '/api/2/tags/' + value + '.json').then(_utils.toJSON);
};
...
var tagName = exports.tagName = function tagName(tag) {
  ...
  if (tag) {
    return fetch(_config2.default + '/api/2/tag/' + tag + '/' + quant + '.json').then(_utils.toJSON);
  }
  return [];
};
